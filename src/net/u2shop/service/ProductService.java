...
public interface ProductService extends BaseService<Product, Long> {
	 ...
	 * @return 商品
	 */
	List<Product> findList(ProductCategory productCategory, Brand brand,  BigDecimal startPrice, BigDecimal endPrice, Boolean isMarketable, Boolean isList, Boolean isTop, Boolean isGift, Boolean isOutOfStock, OrderType orderType, Integer count, List<Filter> filters, List<Order> orders);
	 ...
	 * @return 商品分页
	 */
	Page<Product> findPage(ProductCategory productCategory, Brand brand, BigDecimal startPrice, BigDecimal endPrice, Boolean isMarketable, Boolean isList, Boolean isTop, Boolean isGift, Boolean isOutOfStock,  OrderType orderType, Pageable pageable);
