...
var messages = {
	...
	"admin.validate.email": "请输入正确格式的网址",
	"admin.validate.url": "请输入合法的网址",
	"admin.validate.date": "请输入合法的日期",
	"admin.validate.dateISO": "请输入合法的日期(ISO)",
	"admin.validate.pointcard": "${message("admin.validate.pointcard")}",
	"admin.validate.number": "请输入合法的数字",
	"admin.validate.digits": "只能输入整数",
